  ...
  <div class="container">
    ...
    <section class="lz-trust-block" aria-labelledby="lz-trust-heading">
      ...
      <form class="lz-quick-form" action="https://hub.fixlify.app/book/nicks-appliance-repair-b8c8ce" method="post" aria-label="Quick repair request">
        <p class="lz-quick-form-lead">Send a quick request and we'll contact you shortly.</p>
...
<label class="lz-quick-field"><span>City / Neighbourhood</span><input type="text" name="city" maxlength="80" value="${n.name}, Edmonton" autocomplete="address-level2"></label>
        <label class="lz-quick-field"><span>What needs fixing?</span><textarea name="issue" maxlength="1900" rows="3" placeholder="e.g. Kenmore ${svc.serviceShort} not working"></textarea></label>
