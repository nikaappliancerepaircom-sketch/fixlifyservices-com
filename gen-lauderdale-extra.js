...
<meta name="description" content="${title} in Lauderdale, Edmonton — same-day service, flat $89 diagnostic, 90-day warranty. All brands. Book online or email edmonton@fixlifyservices.com.">
...
<meta property="og:description" content="Same-day ${title.toLowerCase()} in Lauderdale, Edmonton. From $89 diagnostic, 90-day warranty.">
...
{"@context":"https://schema.org","@type":"ProfessionalService","@id":"https://fixlifyservices.com/${prefix}-lauderdale#business","name":"${title} in Lauderdale, Edmonton","description":"${title} in Lauderdale, Edmonton. Same-day service, $89 diagnostic, 90-day warranty.","url":"https://fixlifyservices.com/${prefix}-lauderdale","priceRange":"$","address":{"@type":"PostalAddress","streetAddress":"10025 102A Avenue NW Suite 1000","addressLocality":"Edmonton","addressRegion":"AB","postalCode":"T5J 2Z2","addressCountry":"CA"},"areaServed":[{"@type":"City","name":"Edmonton"},{"@type":"Neighborhood","name":"Lauderdale"}],"serviceType":"${title}"}
<\/script>
</head>
<body>
...
<main class="page-main container" id="main-content">
  <div class="fade-in" style="max-width:760px;font-size:1.0625rem;color:#374151;line-height:1.75;margin-bottom:56px">
    ...
    <p>Who fixes ${applWord} in Lauderdale? <strong>Fixlify Appliance Services Edmonton</strong> &mdash; same-day ${title.toLowerCase()} throughout Lauderdale and surrounding communities. Book online or email <a href="mailto:edmonton@fixlifyservices.com">edmonton@fixlifyservices.com</a>. Flat <strong>$89 diagnostic</strong>, Mon&ndash;Sat 8AM&ndash;8PM, Sun 10AM&ndash;6PM Mountain Time. Typical cost: <strong>${cost} CAD</strong>. <strong>90-day warranty</strong> on every repair.</p>
  ...
  <section style="margin-top:56px">
    ...
    <p style="max-width:760px;color:#374151;line-height:1.7;margin-bottom:20px">All Lauderdale repairs start with a flat <strong>$89 diagnostic</strong>, waived when you proceed with the repair. Written quote before any work begins.</p>
