...
<label class="lz-quick-field"><span>Neighbourhood</span><input type="text" name="city" maxlength="80" value="${n.display}, Edmonton" autocomplete="address-level2"></label>
        <label class="lz-quick-field"><span>What needs fixing?</span><textarea name="issue" maxlength="1900" rows="3" placeholder="e.g. Whirlpool ${svc} not working"></textarea></label>
