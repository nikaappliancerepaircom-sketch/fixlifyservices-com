...
const neighborhoods = [
  ...
  },
  {
    ...
    washerPara: `Falconer's 2000s construction profile means Samsung and LG front-load washers dominate the service call mix. These builder-grade units were installed as standard packages and are now 15 to 20 years old — squarely in the post-warranty service window. Samsung front-loaders in Falconer show door boot seal tears, drain pump failures (5E error), and drum bearing noise. LG units display LE motor errors and OE drain fault codes. Maytag and Whirlpool top-loaders from the 2000s builds show pump wear, lid switch failure, and drive coupler wear. Falconer's newer street network allows efficient dispatch — approximately 27 minutes via Anthony Henday Drive and Ellerslie Road SW. Flat $89 diagnostic, same-day service, 90-day warranty.`,
...
<meta name="description" content="${svc.applianceCap} Repair in ${nb.name}, Edmonton — same-day service, flat $89 diagnostic, 90-day warranty. ${brands[0]}, ${brands[1]}, ${brands[2]} &amp; all brands. Book online or email edmonton@fixlifyservices.com.">
...
<meta property="og:description" content="Same-day ${svc.appliance} repair in ${nb.name}, Edmonton. From $89 diagnostic, 90-day warranty.">
...
{"@context":"https://schema.org","@type":"ProfessionalService","@id":"${url}#business","name":"${svc.applianceCap} Repair ${nb.name} Edmonton","description":"${svc.applianceCap} Repair in ${nb.name}, Edmonton. Same-day service, $89 diagnostic, 90-day warranty.","url":"${url}","priceRange":"$","address":{"@type":"PostalAddress","streetAddress":"10025 102A Avenue NW Suite 1000","addressLocality":"Edmonton","addressRegion":"AB","postalCode":"T5J 2Z2","addressCountry":"CA"},"areaServed":[{"@type":"City","name":"Edmonton"},{"@type":"Neighborhood","name":"${nb.name}"}],"serviceType":"${svc.serviceType}"}
<\/script>
</head>
<body>
...
<section class="page-hero" aria-label="Page header">
  <div class="container">
    ...
    <section class="lz-trust-block" aria-labelledby="lz-h-${slug}">
      ...
      <form class="lz-quick-form" action="https://hub.fixlify.app/book/nicks-appliance-repair-b8c8ce" method="post" aria-label="Quick repair request">
        <p class="lz-quick-form-lead">Send a quick request &mdash; we'll contact you shortly.</p>
        <label class="lz-quick-field"><span>Your name</span><input type="text" name="name" maxlength="80" autocomplete="name" required></label>
        <label class="lz-quick-field"><span>Phone number</span><input type="tel" name="phone" maxlength="20" autocomplete="tel" required></label>
          <label class="lz-quick-field"><span>Service address</span><input type="text" name="address" maxlength="200" autocomplete="street-address" required></label>
<label class="lz-quick-field"><span>Neighbourhood</span><input type="text" name="city" maxlength="80" value="${nb.name}, Edmonton" autocomplete="address-level2"></label>
        <label class="lz-quick-field"><span>What needs fixing?</span><textarea name="issue" maxlength="1900" rows="3" placeholder="${svc.placeholder}"></textarea></label>
        <button type="submit" disabled class="lz-quick-submit">Request a callback</button>
      <label hidden aria-hidden="true">Website<input name="website" tabindex="-1" autocomplete="off"></label>
  <p data-callback-status role="status" aria-live="polite"></p>
  <noscript><p>JavaScript is required for this form. <a href="https://hub.fixlify.app/book/nicks-appliance-repair-b8c8ce">Open online booking</a> or call the number on this page.</p></noscript>
</form>
<script src="/js/callback-form.js" defer></script>
    </section>
...
<main class="page-main container" id="main-content">
  <div class="fade-in" style="max-width:760px;font-size:1.0625rem;color:#374151;line-height:1.75;margin-bottom:56px">
    ...
    <p>Who ${svc.verb} in ${nb.name}? <strong>Fixlify Appliance Services Edmonton</strong> &mdash; same-day ${svc.appliance} repair throughout ${nb.name} and surrounding Edmonton communities. Book online or email <a href="mailto:edmonton@fixlifyservices.com">edmonton@fixlifyservices.com</a>. Flat <strong>$89 diagnostic</strong>, Mon&ndash;Sat 8AM&ndash;8PM, Sun 10AM&ndash;6PM Mountain Time. Typical cost: <strong>${svc.costRange} CAD</strong>. <strong>90-day warranty</strong> on every repair.</p>
    <p>${para}</p>
  ...
  <section style="margin-top:56px">
    ...
    <p style="max-width:760px;color:#374151;line-height:1.7;margin-bottom:20px">All ${nb.name} repairs start with a flat <strong>$89 diagnostic</strong>, waived when you proceed with the repair. Written quote before any work begins.</p>
  ...
  <section style="padding:56px 0;border-top:1px solid #e5e7eb">
    ...
    <details class="faq-item"><summary class="faq-question"><span>How much does ${svc.appliance} repair cost in ${nb.name}?</span><span class="faq-icon">+</span></summary><div class="faq-answer"><p>Typical ${svc.appliance} repair in ${nb.name} runs ${svc.costRangePlain} CAD including parts and labour. Flat $89 diagnostic waived when you proceed with the repair. Written quote before any work begins. 90-day parts and labour warranty.</p></div></details>
...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How fast can you reach ${nb.name}?","acceptedAnswer":{"@type":"Answer","text":"Approximately ${nb.time} minutes via ${nb.route}. Same-day service when you book before 12 PM Monday–Saturday."}},{"@type":"Question","name":"How much does ${svc.appliance} repair cost in ${nb.name}?","acceptedAnswer":{"@type":"Answer","text":"Typical ${svc.appliance} repair in ${nb.name} runs ${svc.costRangePlain} CAD. Flat $89 diagnostic waived with repair. 90-day warranty."}}]}
<\/script>
