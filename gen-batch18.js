...
const services = [
  {
    ...
    faq: (n) => [
      ...
      { q: `How much does dishwasher repair cost in ${n.display}?`, a: `Typical dishwasher repair in ${n.display} runs $120&ndash;$380 CAD including parts and labour. Flat $89 diagnostic waived when you proceed with the repair. Written quote before any work begins. 90-day parts and labour warranty.` }
    ],
    related: (n) => [
  ...
  },
  {
    ...
    faq: (n) => [
      ...
      { q: `How much does washer repair cost in ${n.display}?`, a: `Typical washer repair in ${n.display} runs $130&ndash;$420 CAD including parts and labour. Flat $89 diagnostic waived with repair. 90-day warranty.` }
    ],
    related: (n) => [
  ...
  },
  {
    ...
    faq: (n) => [
      ...
      { q: `How much does fridge repair cost in ${n.display}?`, a: `Typical fridge repair in ${n.display} runs $130&ndash;$480 CAD including parts and labour. Flat $89 diagnostic waived with repair. Written quote before any work begins. 90-day warranty.` }
    ],
    related: (n) => [
      { href: `/dishwasher-repair-${n.slug}`, label: `Dishwasher Repair &mdash; ${n.display}` },
      { href: `/washer-repair-${n.slug}`, label: `Washer Repair &mdash; ${n.display}` },
...
function buildPage(neighborhood, service) {
  ...
  const metaDesc = `${s.display} in ${n.display}, Edmonton — same-day service, flat $89 diagnostic, 90-day warranty. ${s.brands(n).split(',')[0]} & all brands. Book online or email edmonton@fixlifyservices.com.`.slice(0, 160);
  ...
  const businessSchema = JSON.stringify({
    ...
    name: h1,
    description: `${s.display} in ${n.display}, Edmonton. Same-day service, $89 diagnostic, 90-day warranty.`,
    url: canonicalUrl,
    priceRange: '$',
    address: {
      '@type': 'PostalAddress',
...
<meta property="og:description" content="Same-day ${s.display.toLowerCase()} in ${n.display}, Edmonton. From $89 diagnostic, 90-day warranty.">
...
<label class="lz-quick-field"><span>Neighbourhood</span><input type="text" name="city" maxlength="80" value="${n.display}, Edmonton" autocomplete="address-level2"></label>
        <label class="lz-quick-field"><span>What needs fixing?</span><textarea name="issue" maxlength="1900" rows="3" placeholder="e.g. ${s.brands(n).split(',')[0].trim()} ${s.type} not working"></textarea></label>
...
<main class="page-main container" id="main-content">
  <div class="fade-in" style="max-width:760px;font-size:1.0625rem;color:#374151;line-height:1.75;margin-bottom:56px">
    ...
    <p>Who fixes ${s.type === 'dishwasher' ? 'dishwashers' : s.type === 'washer' ? 'washers' : 'fridges'} in ${n.display}? <strong>Fixlify Appliance Services Edmonton</strong> &mdash; same-day ${s.display.toLowerCase()} throughout ${n.display} and surrounding Edmonton communities. Book online or email <a href="mailto:edmonton@fixlifyservices.com">edmonton@fixlifyservices.com</a>. Flat <strong>$89 diagnostic</strong>, Mon&ndash;Sat 8AM&ndash;8PM, Sun 10AM&ndash;6PM Mountain Time. Typical cost: <strong>${s.priceRange} CAD</strong>. <strong>90-day warranty</strong> on every repair.</p>
    <p>${s.contentPara(n)}</p>
